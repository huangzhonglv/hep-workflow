#!/usr/bin/env python3
"""Initialize the hep-idea project directory skeleton without writing files."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Initialize workspace/projects/{project_name}/ for hep-idea "
...
def resolve_repo_root() -> Path:
    ...
    raise RuntimeError(
        ...
        "<repo>/.agents/skills/hep-idea/scripts/ or "
        "<repo>/.claude/skills/hep-idea/scripts/. "
